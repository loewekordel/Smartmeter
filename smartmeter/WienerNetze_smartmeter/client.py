...
class Smartmeter:
    ...
    def __init__(self, username, password):
        ...
        self._api_gateway_token: str = None
        self._access_token_expiration: str = None
        self._refresh_token_expiration: str = None
        self._api_gateway_b2b_token: str = None
    ...
    def credentials_login(self, url: str):
        """
    ...
    def historical_data(
        ...
        if (
            len(data) != 1
            or data[0]["zaehlpunkt"] != zaehlpunkt
            or len(data[0]["zaehlwerke"]) != 1
        ):
